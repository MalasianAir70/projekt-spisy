    ...
    <Dialog open={Boolean(recipe)} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        <Box display="flex" flexDirection="column" alignItems="center">
          <img src={image} alt={label} style={{ width: '100%', maxHeight: '400px', objectFit: 'cover' }} />
          ...
          <Box display="flex" justifyContent="space-between" mt={3} width="100%">
            ...
            <Box flex="1" ml={1}>
              ...
              <Typography variant="body1">
                <a href={url} target="_blank" rel="noopener noreferrer">Wciśnij tutaj, aby sprawdzić pełną instrukcję.</a>
              </Typography>
            </Box>
          </Box>
        </Box>
